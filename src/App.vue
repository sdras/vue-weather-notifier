    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 695.3 452.7" aria-labelledby="title">
      ...
      <g style="isolation:isolate">
        <g id="Layer_1" data-name="Layer 1">
          ...
          <g id="phonebutton" v-on:click="showWeather = !showWeather">
            <transition 
              @before-enter="beforeEnterStroke"
              @enter="enterStroke"
              :css="false"
              appear>
              <path class="main-button" d="M413,272.2c5.1,1.4,7.2,4.7,4.7,7.4s-8.7,3.8-13.8,2.5-7.2-4.7-4.7-7.4S407.9,270.9,413,272.2Z" transform="translate(0 58)" fill="#272829"/>
            </transition>
          ...
          <keep-alive>
            <app-dialog v-if="showWeather" :showWeather="showWeather"></app-dialog>
          </keep-alive>
          <keep-alive>
            <app-droparea v-if="showWeather" :showWeather="showWeather"></app-droparea>
          </keep-alive>
